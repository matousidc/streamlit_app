...
# setup page style
st.set_page_config(
    page_title="My app-test cycling",
    page_icon="🧊",
...
st.markdown(
    "Data taken from [data.brno.cz](https://data.brno.cz/). Two datasets were used, one about cycling infrastructure "
    "and the other one about event 'To work by bike' that takes places every May.")
